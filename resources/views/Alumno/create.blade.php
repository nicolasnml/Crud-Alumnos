					...
					<div class="table-container">
						<form method="POST" action="{{ route('alumno.store') }}"  role="form">
							...
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="numero" id="numero" class="form-control input-sm" placeholder="Número de control">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="promedio" id="promedio" class="form-control input-sm" placeholder="Promedio">
									</div>
								</div>
							</div>
							<div class="row">
